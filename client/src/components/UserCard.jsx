  ...
  return (
    <div key={user._id} className='p-4 pt-6 flex flex-col justify-between w-72 shadow border border-gray-200 rounded-md'>
      ...
      <div className='flex mt-4 gap-2'>
        ...
        {/* connection request or message  button  */}
        <button onClick={handleConnectionRequest} className='rounded-md flex justify-center items-center w-16 border text-slate-500 group active:scale-95 transition cursor-pointer'>
          {
