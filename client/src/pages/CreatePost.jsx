        ...
        <div className='max-w-xl bg-white p-4 sm:p-8 sm:pb:3 rounded-xl shadow-md space-y-4'>
          ...
          {images.length > 0 && (
            ...
            <div className='flex items-center justify-between pt-3 border-t border-gray-300'>
              ...
              })} className='text-sm py-2 px-8 rounded-md bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-700 hover:to-purple-800 active:scale-95 transition text-white cursor-pointer'>
                Publish Post
              </button>
            </div>
        </div>
